...
func NewConfig() *Config {
	...
	v.SetDefault("endpoint", "wss://c00f8ee8.ngrok.io/agent")
	v.SetDefault("api.register", "https://c00f8ee8.ngrok.io/register")
	v.SetDefault("api.auth", "https://c00f8ee8.ngrok.io/agent")
